...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 4.45; //max speed
     ...
     * frontleft turning = 4
     * 
     * frontright driving = 5
     * frontright turning = 6
     * 
     * rearleft driving = 1
     * rearleft turning = 2
     * 
  ...
  public static final class ShooterConstants{
    public static final int shooterLeftPort = 2;
    public static final int shooterRightPort = 3;

    public static final double speakerSpeed = 0.9;
